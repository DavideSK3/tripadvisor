    ...
    <body style="background-color:gainsboro">
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="jumbotron" style="margin-top: 25%; border-radius: 15px; ">
                ...
                <br><br>
                <button type="button" class="btn btn-info " data-toggle="modal" data-target="#myModal2" style="background-color: limegreen; border-color: limegreen; margin-left: 45%;"> Message</button>
