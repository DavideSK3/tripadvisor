    ...
    <body>
        <nav class="navbar header">
            <div class="container-fluid header" >
                <div class="col-md-4 header">
                    <a class="navbar-brand header" href="/TripAdvisor">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-4 col-md-offset-4">
                <h1 class="text-center login-title">Ciao Erminio Ottone ! </h1>
                ...
                <div class="account-wall">
                    ...
                    <div class="jumbotron jumbotron-fluid" style="padding: 20px 0px; border-radius: 5px;">
                        <div style="padding: 0px 20px;">
                            <span style="font-size: 150%"> Nome :    Erminio</span> <br><br>
                            <span style="font-size: 150%"> Cognome :     Ottone</span><br><br>
                        ...
                        <br>
                        <div style="padding: 0px 20px;">
                            <span style="font-size: 150%"> Mail : peppapig@porcamadonna.it </span><br>
                                    ...
                                    <div class="modal-body" style="border-radius: 20px; border-top-width: 0;border-bottom-width: 0;">
                                        <form method='POST' >
                                            <div style="padding-bottom: 20px; ">
                                                <input type="text" name="name" class="form-control" placeholder="Erminio" required>
                                                <input type="text" name="surname" class="form-control" placeholder="Ottone" required>
                                            </div>
                            ...
                            <div class="modal-dialog modal-sm">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body" style="border-radius: 20px; border-top-width: 0;border-bottom-width: 0;">
                                        <form method='POST' >
                                            <div style="padding-bottom: 20px; ">
                                                <input type="email" name="email" class="form-control" placeholder="peppapig@porcamadonna.it" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" required autofocus>
                                            </div>
                                            <input style="float: right" class="btn btn-default" TYPE='submit'>
                                            <button style="float: left" type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                        </form>
                    ...
                    <c:choose>
                        <c:when test="${sessionScope.user.getType() == USER_TYPE.A}">
                            <h1 class="text-center login-title">Gestione Ristoranti </h1>   
                         </c:when>
                    </c:choose>
                </div>
            </div>
        </div>
        <%--<c:out value="${User.USER_TYPE.R}"/>
        <c:out value="${User.toChar(sessionScope.user.getType())}"/>
        <c:choose>
            <c:when test="${sessionScope.user.getType() == User.USER_TYPE.R}">
                <p> ci</p>
