<!-- Pagina a cui si viene indirizzati nel caso in cui si sia dimenticata la password
     Richiede di inserire la propria mail e, nel caso sia corretta, viene inviata una
     mail con un link per accedere alla pagina di cambio password -->
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="jumbotron" style="margin-top: 20%; border-radius: 15px">
                <div class="col-md-offset-1">  
                    ...
                    <span style="font-size: 140%; color: limegreen"><b>Forgot your account's password?</b></span><br>
                    <span style="font-size:130%; color: red;"><i><c:out value='${requestScope.message}'/></i></span><br>
